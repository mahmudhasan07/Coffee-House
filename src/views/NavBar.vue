...
<template >
    <nav class="flex justify-center gap-28 text-white  border-b-2 border-gray-500 py-3 bg-[#AE7E4E]">
        <div>
        ...
        <div class="flex flex-wrap text-xl font-semibold my-auto gap-10">
            ...
            <div class=" p-1 flex flex-col gap-1">
                <router-link class="navtitle" to="/coffees">Coffees & Snacks</router-link>
                <p class="nai "></p>
            </div>
            <div class="p-1 flex flex-col gap-1">
            ...
            <div class="p-1 flex flex-col gap-1">
                <router-link class="navtitle" to="/about">About</router-link>
                <p class="nai"></p>
            </div>
        </div>
    </nav>
